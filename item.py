...
weapon = collections.namedtuple('weapon', 'name desc school attack accuracy critical effect boost weakness cost type range dur shop hidden materials')
item = collections.namedtuple('item','name desc req effect cost type dur shop hidden') #item1 item2 item3 are fusion materials
...
def printformula():
    for i in range(len(catalog)):
        for j in range(len(catalog[i])):
            if isinstance(catalog[i][j], weapon):
                n = catalog[i][j]
                if len(n.materials) > 0:
                    if len(n.materals) == 2:
...
[   
    ...
    weapon("Seliph's Blade","A Calaphian junior lord's blade. Spd and Res +2.","Sword",12,90,15,["Speed","Resist"],2,[None],1530,"W",1,15,[None],[None],[]),
    ...
    weapon("Finn's Lance","A Lenster knight's lance. Def and Lck +2.","Lance",8,85,10,["Defense","Luck"],2,[None],950,"W",1,20,[None],[None],[]),
    weapon("Ephraim's Lance","Magvel prince's greatlance! Str and Spd +2.","Lance",11,80,10,["Strength","Speed"],2,[None],1220,"W",1,20,[None],[None],[]),
    ...
    weapon("Wolt's Bow","A faithful soldier's bow. Use this to recover 20HP.","Bow",10,85,5,["Heal"],20,["Wing"],950,"W",2,25,[None],[None],[]),
    ...
    weapon("Micaiah's Pyre","A Daein magician's tome. Def and Res +2.","Magic",13,85,5,["Defense","Resist"],2,[None],2130,"M",2,15,[None],[None],[]),
...
[
 ...
 [
    weapon("Arcfire","Uncommon fire tome.","Magic",8,80,0,None,None,[None],1440,"M",2,30,[15,21,24],[10,14],["Elfire","Fire"]),
    weapon("Arcthunder","Uncommon thunder tome.","Magic",10,70,10,None,None,[None],1620,"M",2,30,[21,24],[8,10,13,16],["Elthunder","Thunder"]),
    weapon("Arcwind","Uncommon wind tome.","Magic",6,90,0,None,None,["Wing"],1320,"M",2,30,[21,24],[11,13,20],["Elwind","Wind"]),   
    weapon("Ruin","High crit!","Dark Magic",4,65,50,None,None,[None],1380,"M",2,20,[21,22],[8,12,17],["Flux","Wilderwind"]),
    weapon("Steel Sword","Good sword.","Sword",8,90,0,None,None,[None],840,"W",1,30,[7,8,13,14],[2,3,4,5,6],["Iron Sword","Bronze Sword"]),
    weapon("Steel Lance","Good lance.","Lance",9,80,0,None,None,[None],910,"W",1,35,[7,8,12,16],[2,3,4,5,6],["Iron Lance","Bronze Lance"]),
    weapon("Steel Axe","Good axe.","Axe",11,70,0,None,None,[None],980,"W",1,35,[7,8,13,17],[2,3,4,5,6],["Iron Axe","Bronze Axe"]),
    weapon("Steel Bow","Good bow.","Bow",9,80,0,None,None,["Wing"],910,"W",2,35,[7,8,12,20],[2,3,4,5,6],["Iron Bow","Bronze Bow"]),
    weapon("Levin Sword","Thunder magic sword. Can attack from a distance.","Sword",10,80,0,None,None,[None],1600,"M",2,25,[31],[10,13,14,17,18,21,23],["Silver Sword","Elthunder"]),
    weapon("Bolt Axe","Thunder magic axe. Can attack from a distance.","Axe",14,70,5,None,None,[None],1920,"M",2,30,[None],[None],["Silver Axe","Elthunder"]),
    weapon("Noble Rapier","Elegant but deadly.","Sword",8,85,10,None,None,["Horse","Armor"],2100,"W",1,25,[31],[15,24],["Rapier","Steel Sword"]),
    ...
    weapon("Short Spear","Good ranged lance.","Lance",5,75,0,None,None,[None],1600,"W",2,25,[31],[8,10,12,13],["Javelin","Steel Lance"]),
    weapon("Short Axe","Good ranged axe.","Axe",7,65,0,None,None,[None],1750,"W",2,25,[31],[8,11,12,13],["Hand Axe","Steel Axe"]),
 ...
 [
    ...
    weapon("Silver Sword","Somewhat rare sword.","Sword",9,80,0,None,None,[None],1410,"W",1,30,[13,14,15,22,30],[7,8,9,10,11,16,17,20],["Steel Sword","Glass Sword"]),
    weapon("Silver Lance","Somewhat rare lance.","Lance",13,75,0,None,None,[None],1560,"W",1,30,[12,15,16,23,28],[7,8,9,10,11,17,20],["Steel Lance","Glass Lance"]),
    weapon("Silver Axe","Somewhat rare axe.","Axe",15,65,0,None,None,[None],1740,"W",1,30,[13,15,17,23,27],[7,8,9,10,11,16,20],["Steel Axe","Glass Axe"]),
    weapon("Silver Bow","Somewhat rare bow.","Bow",13,75,0,None,None,["Wing"],1560,"W",2,30,[12,15,20,22,29],[7,8,9,10,11,16,17,20],["Steel Bow","Glass Bow"]),
    weapon("Tomahawk","Somewhat rare ranged axe.","Axe",10,60,0,None,None,[None],2550,"W",2,25,[25],[15,23],["Short Axe","Silver Axe"]),
    weapon("Spear","Somewhat rare ranged lance.","Lance",8,70,0,None,None,[None],2400,"W",2,25,[25],[22,24],["Short Spear","Silver Lance"]),
 ...
 [
    weapon("Elite Sword","Carrion's father's memento. Def +5. Gives Paragon.","Sword",9,65,0,["Paragon","Defense"],5,[None],0,"W",1,40,[None],[None],["Silver Sword","Brave Sword","Dracoshield"]),
    weapon("Beo Sword","Beowulf's lost sword. Gives Wrath.","Sword",12,75,30,["Wrath"],0,[None],0,"W",1,20,[None],[None],["Brave Sword","Secret Book","Killing Edge"]),
    weapon("Mareeta's Sword","A cursed sword dispelled by Cyas. Attacks twice and gives Nihil.","Sword",9,70,20,["Brave","Nihil"],0,[None],0,"W",1,30,[None],[None],["Brave Sword","Waste","Dracoshield"]),
    weapon("Holy Sword","Reinhardt's gift to Olwen. Res +5. Gives Miracle. Good against horses. Attack twice.","Sword",12,65,20,["Miracle","Resist","Brave"],5,["Horse"],0,"W",1,20,[None],[None],["Brave Sword","Thoron","Noble Rapier"]),
    weapon("Blaggi Sword","Sword from the Blaggi Tower. Gives Miracle. Good against armor.","Sword",15,70,0,["Miracle"],0,["Armor"],0,"W",1,30,[None],[None],["Noble Rapier","Goddess Icon","Silver Sword"]),
    ...
    weapon("Valflame","Fala's fire magic. Mgc +5.","Magic",16,80,10,["Magic"],5,[None],0,"M",2,25,[None],[None],["Bolganone","Spirit Dust","Dying Blaze"]),
    weapon("Mjolnir","Tordo's thunder magic. Skl +5.","Magic",18,70,20,["Skill"],5,[None],0,"M",2,25,[None],[None],["Thoron","Secret Book","Katarina's Bolt"]),
    weapon("Forseti","Holsety's wind magic. Spd +5.","Magic",14,90,10,["Speed"],5,["Wing"],0,"M",2,25,[None],[None],["Rexcalibur","Speedwing","Celica's Gale"]),
    weapon("Excalibur","Merric's wind tome. High crit.","Magic",13,100,30,None,None,["Wing"],0,"M",2,25,[None],[None],["Rexcalibur","Ruin","Wilderwind"]),
    weapon("Book of Naga","Naga's lost light magic, strong against dragons. Def and Res +5.","Magic",15,80,15,["Defense","Resist"],5,["Dragon"],0,"M",2,3,[None],[None],["Micaiah's Pyre","Katarina's Bolt","Celica's Gale"]),
    weapon("Goetia","Otherworldly grimoire, haunting death by the arcane darkness!","Dark Magic",19,75,10,None,None,[None],0,"M",2,25,[None],[None],["Ruin","Nosferatu","Aversa's Night"]),
    weapon("Sol Katti","A plainsman's blade. Res +5.","Sword",8,100,50,["Resist"],5,[None],0,"W",1,25,[None],[None],["Killing Edge","Talisman","Leif's Blade"]),
    weapon("Amatsu","Yen'fay's ranged blade.","Sword",12,60,5,None,None,[None],0,"W",2,30,[None],[None],["Silver Sword","Javelin","Hand Axe"]),
    weapon("Tyrfing","Baldur's divine sword. Res +5.","Sword",15,85,10,["Resist"],5,[None],0,"W",1,25,[None],[None],["Silver Sword","Talisman","Seliph's Blade"]),
    weapon("Balmung","Odo's assassin blade. Spd +5.","Sword",13,90,10,["Speed"],5,[None],0,"W",1,25,[None],[None],["Silver Sword","Speedwing","Eirika's Blade"]),
    weapon("Mystletainn","Hezul's demon sword. Skl +5.","Sword",14,85,15,["Skill"],5,[None],0,"W",1,25,[None],[None],["Silver Sword","Secret Book","Roy's Blade"]),
    weapon("Ragnell","Ike's ranged blade. Def +5.","Sword",15,70,0,["Defense"],5,[None],0,"W",2,25,[None],[None],["Silver Sword","Dracoshield","Spear"]),
    weapon("Mercurius","Archanea's sword. Powerful.","Sword",17,95,5,None,None,[None],0,"W",1,25,[None],[None],["Glass Sword","Eliwood's Blade","Alm's Blade"]),
    weapon("Gradivus","Archanea's javelin. Use this to recover all HP.","Lance",19,85,5,["Heal"],99,[None],0,"W",2,25,[None],[None],["Spear","Elixir","Short Spear"]),
    weapon("Gungnir","Dain's draconic lance. Str +5.","Lance",16,70,10,["Strength"],5,[None],0,"W",1,25,[None],[None],["Silver Lance","Energy Drop","Glass Lance"]),
    weapon("Hauteclere","Minerva's axe. Use this to recover all HP.","Axe",21,70,5,None,None,[None],0,"W",1,25,[None],[None],["Silver Axe","Elixir","Imposing Axe"]),
    weapon("Helswath","Neir's treasured ranged axe. Def +5.","Axe",18,60,10,["Defense"],5,[None],0,"W",2,25,[None],[None],["Tomahawk","Dracoshield","Orsin's Hatchet"]),
    weapon("Armads","Hector's thunder axe. Def +5.","Axe",17,80,10,["Defense"],5,[None],0,"W",1,25,[None],[None],["Silver Axe","Dracoshield","Glass Axe"]),
    weapon("Parthia","Archanea's bow. Res +5.","Bow",19,95,5,["Resist"],5,[None],0,"W",2,25,[None],[None],["Silver Bow","Talisman","Glass Bow"]),
    weapon("Nidhogg","Frelia's serpent bow. Lck +10.","Bow",16,75,10,["Luck"],10,["Wing"],0,"W",2,25,[None],[None],["Innes' Bow","Goddess Icon","Silver Bow"]),
    weapon("Double Bow","Powerful longbow of unknown origin. Str +5.","Bow",13,70,10,["Strength"],5,["Wing"],0,"W",3,25,[None],[None],["Longbow","Energy Drop","Silver Bow"])
]
