...
[   
    ...
    item("Seraph Robe","Max HP +5.",0,5,300,"B",1,[None],[255]), #HP, Str, Mag, Skl, Spd, Lck, Def, Res
 ...
 [
    ...
    weapon("Rapier","Slender and regal.","Sword",5,90,10,None,None,["Horse","Armor"],1600,"W",1,35,[None],[None]),
...
[
    weapon("Elfire","Upgraded fire tome.","Magic",5,85,0,None,None,[None],980,"M",2,35,[11,19],[None]),
    weapon("Elthunder","Upgraded thunder tome.","Magic",6,75,5,None,None,[None],1050,"M",2,35,[11,19],[None]),
    weapon("Elwind","Upgraded wind tome.","Magic",4,95,0,None,None,["Wing"],910,"M",2,35,[11,19],[None]),
    weapon("Nosferatu","Heal half of the given damage","Dark Magic",7,65,10,"Drain",None,[None],980,"M",2,20,[11,19],[None]),
    weapon("Iron Sword","Basic sword.","Sword",5,95,0,None,None,[None],520,"W",1,40,[2,4,6,10,14],[None]),    
    weapon("Iron Lance","Basic lance.","Lance",6,85,0,None,None,[None],560,"W",1,40,[2,3,9,16],[None]),    
    weapon("Iron Axe","Basic axe.","Axe",7,75,0,None,None,[None],600,"W",1,40,[2,4,9,17],[None]),
    weapon("Iron Bow","Basic bow.","Bow",6,85,0,None,None,["Wing"],560,"W",2,40,[2,3,6,10,20],[None]),
    weapon("Javelin","Basic ranged lance.","Lance",2,80,0,None,None,[None],700,"W",2,25,[5,6,9,12,16,24],[None]),
    weapon("Armorslayer","Strong against armor.","Sword",8,80,0,None,None,["Armor"],1450,"W",1,25,[30],[None]),
    weapon("Wyrmslayer","Strong against wyverns.","Sword",8,80,0,None,None,["Dragon"],1500,"W",1,25,[30],[None]),
    weapon("Beast Killer","Strong against horses.","Lance",9,70,0,None,None,["Horse"],1650,"W",1,25,[],[None]),
    weapon("Hammer","Strong against armor.","Axe",10,60,0,None,None,["Armor"],1850,"W",1,25,[],[None]),
    weapon("Hand Axe","Basic ranged axe.","Axe",3,70,0,None,None,[None],750,"W",2,25,[5,6,9,13,17,24],[None])
],
 [
    weapon("Arcfire","Uncommon fire tome.","Magic",8,80,0,None,None,[None],1440,"M",2,30,[15,21,24],[None]),
    weapon("Arcthunder","Uncommon thunder tome.","Magic",10,70,10,None,None,[None],1620,"M",2,30,[21,24],[None]),
    weapon("Arcwind","Uncommon wind tome.","Magic",6,90,0,None,None,["Wing"],1320,"M",2,30,[21,24],[None]),   
    weapon("Ruin","High crit!","Dark Magic",4,65,50,None,None,[None],1380,"M",2,20,[21,22],[None]),
    weapon("Steel Sword","Good sword.","Sword",8,90,0,None,None,[None],840,"W",1,30,[7,8,13,14],[None]),
    weapon("Steel Lance","Good lance.","Lance",9,80,0,None,None,[None],910,"W",1,35,[7,8,12,16],[None]),
    weapon("Steel Axe","Good axe.","Axe",11,70,0,None,None,[None],980,"W",1,35,[7,8,13,17],[None]),
    weapon("Steel Bow","Good bow.","Bow",9,80,0,None,None,["Wing"],910,"W",2,35,[7,8,12,20],[None]),
    weapon("Levin Sword","Thunder magic sword. Can attack from a distance.","Sword",10,80,0,None,None,[None],1600,"M",2,25,[31],[None]),
    weapon("Bolt Axe","Thunder magic axe. Can attack from a distance.","Axe",14,70,5,None,None,[None],1920,"M",2,30,[None],[None]),
    weapon("Noble Rapier","Elegant but deadly.","Sword",8,85,10,None,None,["Horse","Armor"],2100,"W",1,25,[31],[None]),
    weapon("Killing Edge","High crit!","Sword",9,90,30,None,None,[None],1470,"W",1,30,[14,22],[None]),
    weapon("Killer Lance","High crit!","Lance",10,80,30,None,None,[None],1680,"W",1,30,[16,23],[None]),    
    weapon("Killer Axe","High crit!","Axe",12,70,30,None,None,[None],1860,"W",1,30,[17,23],[None]),
    weapon("Killer Bow","High crit!","Bow",10,80,30,None,None,["Wing"],1680,"W",2,30,[20,22],[None]),
    weapon("Longbow","Can attack from a range of 3.","Bow",9,70,0,None,None,["Wing"],2150,"W",3,25,[31],[None]),
    weapon("Short Spear","Good ranged lance.","Lance",5,75,0,None,None,[None],1600,"W",2,25,[31],[None]),
    weapon("Short Axe","Good ranged axe.","Axe",7,65,0,None,None,[None],1750,"W",2,25,[31],[None]),
    item("Concoction","Good healing potion.",None,20,600,"H",3,[5,6,24],[None])
],
 [
    weapon("Bolganone","Rare fire tome.","Magic",12,75,0,None,None,[None],2000,"M",2,25,[25,30],[None]),
    weapon("Thoron","Rare thunder tome.","Magic",14,65,10,None,None,[None],2200,"M",2,25,[25,28],[None]),
    weapon("Rexcalibur","Rare wind tome.","Magic",10,85,0,None,None,["Wing"],1900,"M",2,25,[25,29],[None]),    
    weapon("Silver Sword","Somewhat rare sword.","Sword",9,80,0,None,[None],None,1410,"W",1,30,[13,14,15,22,30],[None]),
    weapon("Silver Lance","Somewhat rare lance.","Lance",13,75,0,None,[None],None,1560,"W",1,30,[12,15,16,23,28],[None]),
    weapon("Silver Axe","Somewhat rare axe.","Axe",15,65,0,None,None,[None],1740,"W",1,30,[13,15,17,23,27],[None]),
    weapon("Silver Bow","Somewhat rare bow.","Bow",13,75,0,None,None,["Wing"],1560,"W",2,30,[12,15,20,22,29],[None]),
    weapon("Tomahawk","Somewhat rare ranged axe.","Axe",10,60,0,None,[None],None,2550,"W",2,25,[],[None]),
    weapon("Spear","Somewhat rare ranged lance.","Lance",8,70,0,None,[None],None,2400,"W",2,25,[],[None]),
 ...
 [
    weapon("Waste","Attack twice!","Dark Magic",10,45,0,"Brave",None,[None],2160,"M",2,30,[25,29],[None]),
    weapon("Brave Sword","Attack twice!","Sword",9,80,0,"Brave",None,[None],2100,"W",1,30,[26,30],[None]),
    weapon("Brave Lance","Attack twice!","Lance",10,70,0,"Brave",None,[None],2220,"W",1,30,[26,28],[None]),
    weapon("Brave Axe","Attack twice!","Axe",12,60,0,"Brave",None,[None],2400,"W",1,30,[26,27],[None]),
    weapon("Brave Bow","Attack twice!","Bow",10,70,0,"Brave",None,["Wing"],2220,"W",2,30,[26,29],[None]),
